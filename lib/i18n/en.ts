export const en = {
  ...
  services: {
    ...
    cta:{
      ...
      description: "Not sure exactly what you need? No worries: we can figure it out together.",
      primaryButton: "Help me define it",
      secondaryButton: "I don’t know, but I want help🥹",}
  },
  projects: {
    band: "PROJECTS",
    kicker: "PROJECTS",
    headline: "Real projects that turn ideas into product",
    prev: "PREVIOUS",
    next: "NEXT",
    ctaBody: "Your turn. What do you want to build?",
